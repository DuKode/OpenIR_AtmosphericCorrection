...
if src_ds is None:
	...
	#     # 
	# # =============================================================================
	# #      find mtl file based on sourse filenanem  
	# # =============================================================================
	#     #
	#     mtl_filename_list  = src_filename.split(r"_", 1)
	#     mtl_filename = mtl_filename_list[0]
	#     mtl_filename+=("_MTL.txt")
	#     print "MTL filename = ",mtl_filename,
	...
	# def getMTLkeywordValue( mtl_keyword , my_mtl_content ):
	#     for item in my_mtl_content.split("\n"):
	#        if mtl_keyword in item:
	#           return item.split(r" = ", 1)[1]
	# 
	# DATE_ACQUIRED = getMTLkeywordValue( "DATE_ACQUIRED" ,  mtl_content )
	# print DATE_ACQUIRED
# =============================================================================
